package com.sample.yl.mylibrary.happybubble;
...
public class BubbleLayout extends FrameLayout
{
    ...
    private void initAttr(TypedArray a)
    {
        ...
        mBubbleColor = a.getColor(R.styleable.BubbleLayout_bubbleColor,getResources().getColor(R.color.transparent_background));
        a.recycle();
    }
