...
import com.sample.yl.sampledemo.receiver.NetworkChangeEvent;
 ...
 * 在 BaseActivity中监听事件并处理提示视图
 * <p>
 * https://www.jianshu.com/p/aa3a39dcc3af
 * <p>
 * 全局断开网络的提示视图
 */
public class BaseActivity extends AppCompatActivity {
    ...
    /**
     * 如果某个页面不需要网络状态提示，可以在该页面 onCreate 方法中调用 setCheckNetWork(false)
     */
