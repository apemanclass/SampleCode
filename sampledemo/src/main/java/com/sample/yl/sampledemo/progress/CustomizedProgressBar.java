    ...
    private LinearGradient getLinearGradient() {
        if (linearGradient == null) {
            linearGradient = new LinearGradient(0, 0, getWidth(), mHeight, new int[]{mContext.getResources().getColor(R.color.progress_color_1),
                    mContext.getResources().getColor(R.color.progress_color_2), mContext.getResources().getColor(R.color.progress_color_3),
                    mContext.getResources().getColor(R.color.progress_color_4)},
